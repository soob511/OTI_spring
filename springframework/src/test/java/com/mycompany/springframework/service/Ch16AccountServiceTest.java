...
public class Ch16AccountServiceTest extends WebAppTest{
	...
	@Autowired Ch15AccountService accountService;
	...
	public void testTransfer() {
		...
		int toAccount1tBalance = toAccount1.getBalance();
		...
		Assert.assertEquals(toAccount1tBalance+1000,toAccount2.getBalance());
