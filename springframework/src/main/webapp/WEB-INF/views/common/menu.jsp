...
<div class="accordion-item">
  ...
  <div class="accordion-item">
  <h2 class="accordion-header">
    <button class="accordion-button ${chNum=='ch010'?'':'collapsed'}" type="button" data-bs-toggle="collapse" data-bs-target="#ch10" aria-expanded="${chNum=='ch10'}" aria-controls="ch10">
      	Ch10. 예외 처리
    </button>
  </h2>
  <div id="ch10" class="accordion-collapse collapse ${chNum=='ch10'?'show':''}" data-bs-parent="#accordionMenu">
    <div class="accordion-body">
      <ul>
        <li><a href="${pageContext.request.contextPath}/ch10/handlingException1">try-catch이용</a></li>
        ...
        <li><a href="${pageContext.request.contextPath}/ch10/handlingException4">기타 500 예외 처리</a></li>
         <li><a href="${pageContext.request.contextPath}/ch10/jeeaehalmoni">404 처리 </a></li>
      </ul>
    </div>
  </div>
</div>
  ...
  <div class="accordion-item">
  <h2 class="accordion-header">
    <button class="accordion-button ${chNum=='ch011'?'':'collapsed'}" type="button" data-bs-toggle="collapse" data-bs-target="#ch11" aria-expanded="${chNum=='ch11'}" aria-controls="ch11">
      	Ch11. 국제화(다국어) 처리
    </button>
  </h2>
  ...
  <div class="accordion-item">
  <h2 class="accordion-header">
    <button class="accordion-button ${chNum=='ch012'?'':'collapsed'}" type="button" data-bs-toggle="collapse" data-bs-target="#ch12" aria-expanded="${chNum=='ch12'}" aria-controls="ch12">
      	Ch12. 의존성 주입(DI)
    </button>
  </h2>
  ...
  <div class="accordion-item">
  <h2 class="accordion-header">
    <button class="accordion-button ${chNum=='ch014'?'':'collapsed'}" type="button" data-bs-toggle="collapse" data-bs-target="#ch14" aria-expanded="${chNum=='ch14'}" aria-controls="ch14">
      	Ch14. AOP
    </button>
  </h2>
  <div id="ch14" class="accordion-collapse collapse ${chNum=='ch14'?'show':''}" data-bs-parent="#accordionMenu">
    <div class="accordion-body">
      <ul>
          <li><a href="${pageContext.request.contextPath}/ch14/before">메소드 호출전에 공통 코드 실행</a></li>
           <li><a href="${pageContext.request.contextPath}/ch14/after">메소드 호출후에 공통 코드 실행</a></li>
            <li><a href="${pageContext.request.contextPath}/ch14/afterReturning">메소드가 정상적으로 리턴값을 제공할 경우</a></li>
            <li><a href="${pageContext.request.contextPath}/ch14/afterThrowing">메소드에서 예외가 발생할 경우 공통 코드 실행</a></li>
            <li><a href="${pageContext.request.contextPath}/ch14/around">메소드호출 전후에 공통 코드 실행</a></li>
            <li><a href="${pageContext.request.contextPath}/ch14/boardList">사례 : 실행시간측정</a></li>
  ...
  <div class="accordion-item">
  <h2 class="accordion-header">
    <button class="accordion-button ${chNum=='ch015'?'':'collapsed'}" type="button" data-bs-toggle="collapse" data-bs-target="#ch15" aria-expanded="${chNum=='ch15'}" aria-controls="ch15">
      	Ch15. Transaction처리
    </button>
  </h2>
  <div id="ch15" class="accordion-collapse collapse ${chNum=='ch15'?'show':''}" data-bs-parent="#accordionMenu">
    <div class="accordion-body">
      <ul>
          <li><a href="${pageContext.request.contextPath}/ch15/accountList">계좌이체</a></li>
 ...
 <div class="accordion-item">
  <h2 class="accordion-header">
    <button class="accordion-button ${chNum=='ch017'?'':'collapsed'}" type="button" data-bs-toggle="collapse" data-bs-target="#ch17" aria-expanded="${chNum=='ch17'}" aria-controls="ch17">
      	Ch17. 스프링 시큐리티
    </button>
  </h2>
  <div id="ch17" class="accordion-collapse collapse ${chNum=='ch17'?'show':''}" data-bs-parent="#accordionMenu">
    <div class="accordion-body">
      <ul>
          ...
          <li><a href="${pageContext.request.contextPath}/ch17/userInfo">로그인한 사용자 정보 보기</a></li>
