...
public class Ch03Controller {
	...
	public String defaultValue(String param1,
			@RequestParam(defaultValue="0") int param2, //데이터가 들어오지 않을경우 디폴트값 지정
	...
	public String otherArgName(
			@RequestParam("param1")String arg1,//기본속성값
			@RequestParam(value="param2",defaultValue="0") int arg2, //데이터가 들어오지 않을경우 디폴트값 지정
