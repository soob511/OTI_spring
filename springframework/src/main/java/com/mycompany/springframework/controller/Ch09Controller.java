...
import com.mycompany.springframework.dto.Ch09MutiFileUploadForm;
...
public class Ch09Controller {
	...
	public String singleFileUpload(Ch09FileUploadForm form) throws IllegalStateException, IOException {
	...
	public String multiFileUpload(Ch09MutiFileUploadForm form) throws IllegalStateException, IOException {
	...
	public String downloadFileLsit(Model model) {
		model.addAttribute("chNum","ch09");
	...
	public void downloadFile(String fileName,HttpServletRequest request,  HttpServletResponse response) throws IOException {
		...
		Files.copy(path, out);//path 에서 데이터를 읽어서 out으로 복사해라
		out.flush();
		out.close();
	}
